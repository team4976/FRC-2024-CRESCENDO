...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double driveKI = 0.0;//was 0
        public static final double driveKD = 0.0;//was 0
        ...
        /** Meters per Second */
        public static final double maxSpeed = 0.75; //TODO: This must be tuned to specific robot //4.5 set to 0.5 to make testing safer
        /** Radians per Second */
